...
def generate_html 
    ...
    series_list.each do |series|
        ...
        episodes_list.each do |episode|
            ...
            series_text = series_text + '<div class="no example"><h4 class="ui header">'+episode["episode"]+' - '+episode["title"].gsub(",","")+'</h4>'
